...
<Badge variant="primary">v0.1.3</Badge> <Badge variant="secondary">Rust Core</Badge> <Badge variant="outline">Python Binding</Badge>
...
└── tools/
    └── motor_calib/     # Motor calibration tool
```
